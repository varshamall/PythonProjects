...
background = pygame.image.load('venv/background.png')
user = pygame.image.load('venv/face.png')
chicken = pygame.image.load('venv/chicken.png')
...
def random_offset():
    return -1*random2.randint(100, 1500)
